...
class RateLimiter {
    constructor() {
        ...
        this.config = {
            'player_move': { maxPerSecond: 30, blockDuration: 5000 },
    ...
    cleanup() {
        ...
        for (const [key, limit] of this.limits.entries()) {
            // Xóa cả blocked và các entry cũ hơn 5 phút
            if ((limit.blocked && now > limit.blockUntil) || (now - limit.resetTime > 300000)) {
